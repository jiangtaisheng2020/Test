...
- (instancetype)initWithFrame:(CGRect)frame image:(UIImage *)image
{
    if (self = [super init]) {
        ...
        _slider.value = 0.5;
//        _slider.thumbTintColor = REDCOLOR;
        _slider.minimumTrackTintColor = Color(239, 68, 84);
...
//        [_resetBtn setTitleColor:[UIColor resetButtonHighlightedColor] forState:UIControlStateHighlighted];
        ...
        [_resetBtn setTitleColor:Color(239, 68, 84) forState:UIControlStateHighlighted];
        [_resetBtn setTitle:NSLocalizedStringFromTable(@"重置", @"PhotoTweaks", nil) forState:UIControlStateNormal];
