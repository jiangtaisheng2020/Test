...
//    [cancelBtn setTitleColor:cancelHighlightTitleColor forState:UIControlStateHighlighted];
    [cancelBtn setTitleColor:kRedColor forState:UIControlStateHighlighted];
    ...
    [cropBtn setTitle:NSLocalizedStringFromTable(@"上传", @"PhotoTweaks", nil) forState:UIControlStateNormal];
    [cropBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    
    
    [cropBtn setTitleColor:kRedColor forState:UIControlStateHighlighted];
...
- (void)saveBtnTapped
{
    ...
    #warning 需要修改请求
//    [ShowActivity showActivityTips:@"上传中..." superView:self.view];
    //上传头像
